...
import type { FileNode, FileSystemAPI, FileSystemTree, DirEnt } from "@webcontainer/api";
...
> = {
    ...
    ) => FsReturn<FsKey> extends ApplyRemap<Pick<FsReturn<FsKey, ExtractionConfig>, ReturnKey>, Remap> ? ApplyRemap<Pick<FsReturn<FsKey, ExtractionConfig>, ReturnKey>, Remap> : {
